 ...
 * @author Jose Santos
 */
public class AceptaTarjeta extends JFrame {

    public JPanel panel = new JPanel(); // creación de panel

    public AceptaTarjeta() {
        ...
        this.setTitle("Aprobación de Tarjea");//Titulo de la ventana
...
//        panel.add(txtTelefono);
    ...
    private void ListaDesplegable() {
        ...
        id = new String[Inicio.contadorSolicitarTarjeta];
        for (int i = 0; i < Inicio.contadorSolicitarTarjeta; i++) {
            id[i] = Inicio.solicitarTarjeta[i].getIdSolicitud() + "";
    ...
    private void MostrarDatos() {
        ...
        if (Inicio.contadorSolicitarTarjeta == 0) {
            ...
            cliente = Inicio.solicitarTarjeta[val - 1].getCliente();
        ...
        ActionListener oyente5 = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (Inicio.contadorSolicitarTarjeta == 0) {
                    ...
                    for (int i = valor - 1; i < Inicio.contadorSolicitarTarjeta - 1; i++) {
                        Inicio.solicitarTarjeta[i] = Inicio.solicitarTarjeta[i + 1];
                        Inicio.solicitarTarjeta[i].setIdSolicitud(i + 1);
                    }

                    System.out.println("Actual: " + Inicio.contadorSolicitarTarjeta);
                    if (Inicio.contadorSolicitarTarjeta > 0) {
                        Inicio.contadorSolicitarTarjeta--;
                        System.out.println("Despues " + Inicio.contadorSolicitarTarjeta);
                    }
        ...
        ActionListener oyente = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (Inicio.contadorSolicitarTarjeta == 0) {
                    ...
                    if (m.matches() == true) {
                        ini.CrearTarjeta(Double.parseDouble(txtCredito.getText()),Inicio.solicitarTarjeta[valor-1].getCliente());

                        for (int i = 0; i < Inicio.contadorTarjeta; i++) {
                            System.out.println("Fecha de Vencimiento " + Inicio.tarjeta[i].getFechaVencimiento());
                            System.out.println("Numero de Tarjeta " + Inicio.tarjeta[i].getNumeroTarjeta());
                            System.out.println("Monto: " + Inicio.tarjeta[i].getLimiteCredito());
                        }
                        JOptionPane.showMessageDialog(null, "Se acepto con éxito", "Informacion", JOptionPane.INFORMATION_MESSAGE);
                    } else {
                        JOptionPane.showMessageDialog(null, "Debe ingresar unicamente\nnumeros", "Informacion", JOptionPane.INFORMATION_MESSAGE);
                    }
