 ...
 * @author Jose Santos
 */
public class AreaCaja extends JFrame{
    ...
    private void Botones() {
        ...
        ActionListener oyente4 = new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                PagoServicio eliminar = new PagoServicio();
                dispose();
        ...
        ActionListener oyente7 = new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                PagoPrestamo pa = new PagoPrestamo();
                dispose();
                pa.setVisible(true);
            }
        };
