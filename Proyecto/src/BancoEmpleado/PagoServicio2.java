 ...
 * @author Jose Santos
 */
public class PagoServicio2 extends JFrame {

    public JPanel panel = new JPanel(); // creación de panel

    public PagoServicio2() {
        ...
        this.setTitle("Pago de Servicios");//Titulo de la ventana
    ...
    private void AreaTexto() {
        ...
        txtPago.setBounds(150, 183, 150, 25);
...
//        panel.add(etiqueta1);
        ...
        etiqueta4.setText("Servicio"); //Texto de la etiqueta
        etiqueta4.setBounds(12, 155, 120, 16);
        panel.add(etiqueta4);

        JLabel etiqueta5 = new JLabel();//Creamos una etiqueta
        etiqueta5.setText("Tipo de pago"); //Texto de la etiqueta
        ...
        ActionListener oyente4 = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (Inicio.contadorCuenta == 0) {
                    ...
                    if (txtCuenta.getText().equals("") || txtMonto.getText().equals("") || txtPago.getText().equals("") || txtTelefono.getText().equals("")) {
                        JOptionPane.showMessageDialog(null, "Llene todos los campos, son obligatorios", "Informacion", JOptionPane.INFORMATION_MESSAGE);
                    } else {
