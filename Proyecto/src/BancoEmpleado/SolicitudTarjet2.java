 ...
 * @author Jose Santos
 */
public class SolicitudTarjet2 extends JFrame {

    public JPanel panel = new JPanel(); // creación de panel

    public SolicitudTarjet2() {
        ...
        this.setTitle("Solicitud Tarjeta");//Titulo de la ventana
    ...
    private void Etiquetas() {
        ...
        JLabel etiqueta2 = new JLabel("Tarjeta de Crédito");
        ...
        ActionListener oyente = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if(Inicio.contadorCliente == 0){
                    ...
                    ini.Solicitud(idCliente);
                    JOptionPane.showMessageDialog(null, "Se hizo la solicitud");
                }
                
                for (int i = 0; i < Inicio.contadorSolicitarTarjeta; i++) {
                    System.out.println("No. Solicitud: "+Inicio.solicitarTarjeta[i].getIdSolicitud());
                    System.out.println("Id Cliente: "+Inicio.solicitarTarjeta[i].getCliente()+"\n");
                }
