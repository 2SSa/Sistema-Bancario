 ...
 * @author Jose Santos
 */
public class CargarCliente2 extends JFrame{
    public JPanel panel = new JPanel(); // creación de panel

    public CargarCliente2() {
    ...
    private void Etiquetas() {
        JLabel etiqueta1 = new JLabel("Area de Carga de Clientes");
    ...
    private void Botones() {
        ...
        ActionListener oyente2 = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                String expRegular = "[0-9]+;[a-zA-Z ]+;[0-9a-zA-Z ]+;[0-9]{8}";
                String errores = "";
                boolean verificaId;
                if (texto.equals("")) {
                    ...
                    for (int a = 0; a < arrCliente.length; a++) {
                        ...
                        if (m.matches() == true) {
                            ...
                            if (verificaId == false) {
                                ...
                                inicio.CrearCliente(Integer.parseInt(valores[0]), valores[1], valores[2], valores[3], 0);
                            }
