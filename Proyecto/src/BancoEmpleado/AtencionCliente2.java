...
import FormCliente.BuscarCliente;
import FormCliente.EditarCliente;
 ...
 * @author Jose Santos
 */
public class AtencionCliente2 extends JFrame {

    public JPanel panel = new JPanel(); // creación de panel

    public AtencionCliente2() {
    ...
    private void Botones() {
        ...
        btnEliminacion.setText("Crear Cliente");
        ...
        ActionListener oyente = new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                CargaCuenta2 cuenta = new CargaCuenta2();
                dispose();
        ...
        ActionListener oyente2 = new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                SolicitudPres2 pres = new SolicitudPres2();
                dispose();
        ...
        ActionListener oyente3 = new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                SolicitudTarjet2 edit = new SolicitudTarjet2();
                dispose();
        ...
        ActionListener oyente4 = new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                CargarCliente2 eliminar = new CargarCliente2();
                dispose();
