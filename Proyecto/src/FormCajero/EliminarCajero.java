...
public class EliminarCajero extends JFrame{
    ...
    public EliminarCajero() {
        ...
        this.setTitle("Eliminar Cajero");//Titulo de la ventana
    ...
    private void Etiquetas() {
        ...
        etiqueta2.setText("Dirección"); //Texto de la etiqueta
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (Inicio.contadorCajero == 0) {
                    ...
                    if (Inicio.contadorCajero == 0) {
                        ...
                        if (encontrado == true) {
                            for (int i = pos; i < Inicio.contadorCajero - 1; i++) {
                                Inicio.cajero[i] = Inicio.cajero[i + 1];
                                System.out.println("Actual " + Inicio.contadorCajero);

                            }

                            if (Inicio.contadorCajero >= 1) {
                                Inicio.contadorCajero--;
                                System.out.println("Despues " + Inicio.contadorCajero);
                            }
//                            EliminarAgencia elimina = new EliminarAgencia();
//                            dispose();
//                            elimina.setVisible(true);
                            JOptionPane.showMessageDialog(null, "Se ha eliminado al cajero\ncon éxito", "Informacion", JOptionPane.INFORMATION_MESSAGE);
                        }
                    }
                }
            }
