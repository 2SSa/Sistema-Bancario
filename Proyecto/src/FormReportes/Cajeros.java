...
public class Cajeros extends JFrame {
    ...
    public Cajeros() {
        ...
        this.setTitle("Reporte de Cajeros");//Titulo de la ventana
    ...
    private void Etiquetas() {
        JLabel etiqueta1 = new JLabel("Reporte de Cajeros");
    ...
    private void Tabla() {
        ...
        for (int i = 0; i < Inicio.contadorCajero; i++) {
            valores[0] = Inicio.cajero[i].getId()+"";
            valores[1] = Inicio.cajero[i].getUbicacion()+"";
            valores[2] = Inicio.cajero[i].getEfectivo()+"";
            valores[4] = Inicio.cajero[i].getCantidadUsado()+"";
            if(Inicio.cajero[i].getEstado()==true){
                valores[3] ="Activo";
            }else{
                valores[3]="Mantenimiento";
            }
