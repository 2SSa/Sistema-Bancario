 ...
 * @author Jose Santos
 */
public class EmpleadosAgencia extends JFrame {

    public JPanel panel = new JPanel(); // creación de panel

    public EmpleadosAgencia() {
        ...
        this.setTitle("Empleados Agencia");//Titulo de la ventana
    ...
    private void Etiquetas() {
        JLabel etiqueta1 = new JLabel("Reporte de Empleados Bancarios");
    ...
    private void Tabla() {
        ...
        modelo1.addColumn("Identificador Agencia");
        ...
        for (int i = 0; i < Inicio.contadorBanco; i++) {
            for (int j = 0; j < Inicio.contadorEmpleado; j++) {
                if (Inicio.empleado[j].getAsignacion().equals("AB")) {
                    if (Inicio.banco[i].getId() == Inicio.empleado[j].getIdAgencia()) {
                        valores[0] = Inicio.banco[i].getId() + "";
                        valores[1] = Inicio.empleado[j].getId() + "";
                        valores[2] = Inicio.empleado[j].getNombre();
                        valores[3] = Inicio.empleado[j].getDireccion();
