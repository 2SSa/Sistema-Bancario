...
public class EliminarCliente extends JFrame {
    ...
    public EliminarCliente() {
        ...
        this.setTitle("Eliminar Cliente");//Titulo de la ventana
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (Inicio.contadorCliente == 0) {
                    ...
                    if (Inicio.contadorCliente == 0) {
                        ...
                        if (encontrado == true) {
                            for (int i = pos; i < Inicio.contadorCliente - 1; i++) {
                                Inicio.cliente[i] = Inicio.cliente[i + 1];
                                System.out.println("Actual " + Inicio.contadorCliente);

                            }

                            if (Inicio.contadorCliente >= 1) {
                                Inicio.contadorCliente--;
                                System.out.println("Despues " + Inicio.contadorCliente);
                            }
