 ...
 * @author Jose Santos
 */
public class BuscarAutobanco extends JFrame{
    public JPanel panel = new JPanel(); // creación de panel

    public BuscarAutobanco() {
        ...
        this.setTitle("Buscar Autobanco");//Titulo de la ventana
    ...
    private void AreaTexto() {
        ...
        txtCajas.setBounds(130, 213, 200, 25);
    ...
    private void Etiquetas() {
        ...
        JLabel etiqueta6 = new JLabel("Cajas Autobanco");//Creamos una etiqueta
                ...
                if (txtId.getText().equals("")) {
                    ...
                    if (m.matches() == true) {
                        if (Inicio.contadorBanco == 0) {
                            ...
                            if (agencia == true && tipoAgencia==true) {
                                ...
                                JOptionPane.showMessageDialog(null, "El autobanco no se encuentra registrado", "Informacion", JOptionPane.INFORMATION_MESSAGE);
                            }
                        }
                    } else {
