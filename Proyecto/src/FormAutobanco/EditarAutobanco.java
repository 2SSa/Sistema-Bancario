 ...
 * @author Jose Santos
 */
public class EditarAutobanco extends JFrame {

    public JPanel panel = new JPanel(); // creación de panel

    public EditarAutobanco() {
    ...
    private void MostrarDatos() {
        ...
        if (Inicio.contadorBanco == 0) {
            ...
            if (encontrado == true && tipoAgencia == true) {
    ...
    private void Etiquetas() {
        ...
        JLabel etiqueta9 = new JLabel("Cajas Autobanco");//Creamos una etiqueta
        etiqueta9.setBounds(12, 295, 120, 16);
        panel.add(etiqueta9);
    }
    ...
    private void Botones() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (Inicio.contadorBanco == 0) {
                    ...
                    if (Inicio.contadorBanco == 0) {
                        ...
                        if (encontrado == true) {
                            Inicio.banco[pos].setDireccion(txtDireccion.getText());
                            Inicio.banco[pos].setNombreAgencia(txtNombre.getText());
                            Inicio.banco[pos].setEfectivo(Double.parseDouble(txtEfectivo.getText()));
                            Inicio.banco[pos].setNoServicioCliente(Integer.parseInt(txtEscritorios.getText()));
                            Inicio.banco[pos].setNumeroCajas(Integer.parseInt(txtNumeroCajas.getText()));
                            Inicio.banco[pos].setNumeroTelefono(txtTelefono.getText());
                            Inicio.banco[pos].setCajasAutobanco(Integer.parseInt(txtCajas.getText()));
        ...
        ActionListener oyente3 = new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                MenuAutobanco inicio = new MenuAutobanco();
                dispose();
