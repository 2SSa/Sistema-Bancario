...
public class CargarEmpleado extends JFrame{
    ...
    private void Etiquetas() {
        JLabel etiqueta1 = new JLabel("Area de Carga de Empleados");
    ...
    private void Botones() {
        ...
        ActionListener oyente2 = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                String expRegular = "[a-zA-Z ñÑáéíóúÁÉÍÓÚ ]+;[a-zA-Z0-9 ]+;[a-zA-Z0-9 ]+;[a-zA-Z0-9 ]+";
                String errores = "";
                boolean verificaId;
                if (texto.equals("")) {
...
//                                if (Integer.parseInt(valores[0]) == Inicio.empleado[i].getId()) {
//                                    verificaId = true;
...
//                            }
                            ...
                            if (verificaId == false) {
                                ...
                                inicio.CrearEmpleado(valores[0], valores[1], valores[2], valores[3]);
                            }
