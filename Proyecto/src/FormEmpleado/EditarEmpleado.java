...
public class EditarEmpleado extends JFrame {
    ...
    public EditarEmpleado() {
        ...
        this.setTitle("Editar Empleado");//Titulo de la ventana
        ...
        ActionListener oyente = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (Inicio.contadorEmpleado == 0) {
                    ...
                    JOptionPane.showMessageDialog(null, "Por favor, llene todos los campos solicitados", "Error", JOptionPane.ERROR_MESSAGE);
                } else {
                    boolean encontrado = false;
                    int pos = 0;
                    if (Inicio.contadorEmpleado == 0) {
                        ...
                        if (encontrado == true) {
                            Inicio.empleado[pos].setDireccion(txtDireccion.getText());
                            Inicio.empleado[pos].setNombre(txtNombre.getText());
                             if(txtAsignacion.getText().equalsIgnoreCase("ab")||txtAsignacion.getText().equalsIgnoreCase("dpg")||txtAsignacion.getText().equalsIgnoreCase("dpm")||txtAsignacion.getText().equalsIgnoreCase("dpi")||txtAsignacion.getText().equalsIgnoreCase("dpf")||txtAsignacion.getText().equalsIgnoreCase("dpr")||txtAsignacion.getText().equalsIgnoreCase("dpc")||txtAsignacion.getText().equalsIgnoreCase("cc")){
                                 Inicio.empleado[pos].setAsignacion(txtAsignacion.getText().toUpperCase());
                             }
