 ...
 * @author Jose Santos
 */
public class CargarBanco extends JFrame {
    ...
    private void Etiquetas() {
        JLabel etiqueta1 = new JLabel("Area de Carga de Agencias Bancarias");
    ...
    private void Botones() {
        ...
        ActionListener oyente2 = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                String expRegular = "[a-zA-Z0-9 ]+;[0-9]+;[0-9a-zA-Z ]+;[0-9]{8};[0-9]+;[0-9]+;[0-9]+;(NO|no)[ ]*";
                String errores = "";
                boolean verificaId;
                if (texto.equals("")) {
                    ...
                    for (int a = 0; a < arrBanco.length; a++) {
                        ...
                        if (m.matches() == true) {
                            ...
                            if (verificaId == false) {
                                ...
                                inicio.CrearBanco(valores[0], Integer.parseInt(valores[1]), valores[2], valores[3], Integer.parseInt(valores[4]), Integer.parseInt(valores[5]), Integer.parseInt(valores[6]), false, 0, 0);
                            }
