...
public class EditarAgencia extends JFrame {
    ...
    public EditarAgencia() {
        ...
        this.setTitle("Editar");//Titulo de la ventana
    ...
    private void MostrarDatos() {
        ...
        if (Inicio.contadorBanco == 0) {
            ...
            if (encontrado == true && tipoAgencia == false) {
    ...
    private void Botones() {
        ...
        ActionListener oyente = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                else if (txtDireccion.getText().equals("") || txtEfectivo.getText().equals("") || txtEscritorios.getText().equals("") || txtNombre.getText().equals("") || txtNumeroCajas.getText().equals("") || txtTelefono.getText().equals("")) {
